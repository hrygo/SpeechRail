...
- Python 固定为 `>=3.12,<3.13`，使用 `uv` 与 PEP 621；Native 运行目标为 Apple Silicon macOS 26.0，`SpeechRailApp`、ControlKit、ControlAgent、CaptureHelper 与服务侧 SwiftPM worker 统一以 macOS 26.0 为最低版本，不保留旧系统 Native 兼容分支。
