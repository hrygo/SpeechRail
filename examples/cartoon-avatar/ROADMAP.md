...
当前状态：**R0 首版示例代码已实现；当前实现已提前落地 R1 的单角色立绘和有限动作基础，R1 的外观预设、角色绑定等其余内容仍未完成。** 本路线图不替代当前代码、README 和实际验收记录。R1–R5 的其余内容是后续候选迭代，不代表已经排期或授权实施。阶段编号是本示例的产品里程碑，与 SpeechRail 服务版本无关。
