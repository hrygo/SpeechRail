...
2. Debug/Release 使用 ad hoc 或本机可用的 development signing；Distribution 才使用 Developer ID Application。
...
- UI/integration tests 使用临时 app home、端口和 helper label；测试结束必须注销临时 LaunchAgent 并清理临时目录。
