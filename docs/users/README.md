...
|---|---|---|---|
| ASR | `speechrail/qwen3-asr-1.7b` | `whisper-1`、`gpt-4o-transcribe`、`gpt-4o-mini-transcribe` | `/v1/audio/transcriptions`、`/v1/realtime` transcription |
| TTS | `speechrail/qwen3-tts` | `tts-1`、`tts-1-hd`、`gpt-4o-mini-tts` | `/v1/audio/speech`、`/v1/realtime` speech |
