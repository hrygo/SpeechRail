...
- [ ] **Step 1: Record the Python rejection matrix in the contract**
...
- [ ] **Step 2: Add canonical Swift contract values and encoding tests**
...
- [ ] **Step 3: Replace the active contract prose with target semantics**
...
- [ ] **Step 4: Run the Swift pure contract tests**
...
- [ ] **Step 5: Commit the contract fixture and shared types**
...
- [ ] **Step 1: Add failing parser tests for current-only input and old-event rejection**
...
- [ ] **Step 3: Implement current-only session parsing**
...
- [ ] **Step 4: Replace `_pending_text` and conversation-shaped TTS with one request state**
...
- [ ] **Step 5: Implement TTS output and receipt metadata**
...
- [ ] **Step 6: Implement explicit cancel and disconnect finalization**
...
- [ ] **Step 7: Remove server-side LLM design surfaces**
...
- [ ] **Step 8: Run the focused Realtime regression**
...
- [ ] **Step 9: Commit the server state machine**
...
- [ ] **Step 1: Add failing tests for Native wire output**
...
- [ ] **Step 2: Run pure Swift tests and verify the wire test fails**
...
- [ ] **Step 3: Change `RealtimeASRClient` to canonical events**
...
- [ ] **Step 4: Keep LLM and assistant state inside `AssistantSession`**
...
- [ ] **Step 5: Keep Caption and Meeting ASR-only**
...
- [ ] **Step 6: Run Swift contract tests**
...
- [ ] **Step 7: Commit Native alignment**
...
- [ ] **Step 2: Remove any server-LLM readiness projection**
...
- [ ] **Step 3: Preserve the nine MCP tools and three resources**
...
- [ ] **Step 4: Add MCP schema assertions**
...
- [ ] **Step 6: Commit MCP and capability alignment**
...
- [ ] **Step 1: Replace architecture diagrams and responsibility tables**
...
- [ ] **Step 2: Update MCP documentation without adding a realtime tool**
...
- [ ] **Step 3: Add Native caller orchestration example**
...
- [ ] **Step 4: Remove stale external-LLM commitments**
...
- [ ] **Step 1: Add a fake loopback end-to-end test**
...
- [ ] **Step 2: Run the focused end-to-end tests**
...
- [ ] **Step 3: Update the breaking version**
...
- [ ] **Step 4: Run authorized static and contract gates**
...
- [ ] **Step 5: Record the evidence matrix**
...
- [ ] **Step 6: Inspect staged diff and commit the release candidate metadata**
